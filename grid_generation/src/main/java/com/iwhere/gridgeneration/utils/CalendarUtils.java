...
public class CalendarUtils {
     ...
     * @return
     */
    public static Date getDayBegin(Date oneDay){
        Calendar cal = new GregorianCalendar();
        cal.setTime(oneDay);
        cal.set(Calendar.HOUR_OF_DAY, 0);
        cal.set(Calendar.MINUTE, 0);
     ...
     * @return
     */
    public static Date getDayEnd(Date oneDay){
        Calendar cal = new GregorianCalendar();
        cal.setTime(oneDay);
        cal.set(Calendar.HOUR_OF_DAY, 23);
        cal.set(Calendar.MINUTE, 59);
     ...
     * @return
     */
    public static java.util.Date getYearDay(int x, Date dat) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(dat);
     ...
     * @return
     */
    public static java.util.Date getMonthDay(int x, Date dat) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(dat);
		SimpleDateFormat Format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
		cal.add(cal.MONTH, x);
    ...
    public static int getDiffDays(Date beginDate, Date endDate) {
        ...
        long diff = ((endDate.getTime() - beginDate.getTime())%(1000 * 60 * 60 * 24)!=0?
